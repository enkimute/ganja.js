...
(function (name, context, definition) {
  ...
  // Generate a new class for our algebra.
    ...
    // Static operators (easier integration with scalars when using inline operator overloading)
      ...
      static Pow(a,b,res)   {  a=a.call?a():a; b=b.call?b():b; if (a.length==1 && a[0].length==1) return [[Element.Pow(a[0][0],b)]]; if (b==2) return this.Mul(a,a,res);if (!(a instanceof Element || b instanceof Element)) return a**b; if (a==Math.E) return b.Exp(); a=Element.toEl(a); if (b==-1) return a.Inverse;  return a.Pow(b); }  
