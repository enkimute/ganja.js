...
(function (name, context, definition) {
  ...
  // Generate a new class for our algebra.
    ...
    // Static operators (easier integration with scalars when using inline operator overloading)
      ...
      static Pow(a,b,res)   {  a=a.call?a():a; b=b.call?b():b; if (!(a instanceof Element || b instanceof Element)) return a**b; if (a==Math.E) return b.Exp(); a=Element.toEl(a); if (b==-1) return a.Inverse; if (b==2) return a.Mul(a); return a.Pow(b); }  
