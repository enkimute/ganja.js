...
You can now use this class to generate elements of your algebra. (for
example complex numbers, quaternions, multivectors, etc .. ).

The elements generated by your Algebra class will have all of the
expected properties. (length, blade access, dot, wedge, mul, dual, inverse, ...)

These elements can (although not advised) be used in a 'classic' programming 
style math syntax like the example below.
...
See the [free ganja samples](https://enkimute.github.io/ganja.js/examples/coffeeshop.html) for more
